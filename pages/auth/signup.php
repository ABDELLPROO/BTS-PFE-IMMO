<div class="bg-bottom bg-fixed w-full py-[5.75rem] bg-[url('./photo-login.jpg')] bg-no-repeat bg-cover">
<div class=" max-w-sm p-6 m-auto bg-white rounded-md shadow-md dark:bg-gray-600 ">
    <div class="flex items-center justify-between mt-4">
        ...
        <form class="mt-6">
            ...
            <div class="mt-4">
               <input type="email" name="Adresse email" placeholder="Adresse email *"
                    class="text-sm block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40">
            </div>

            <div class="mt-4">
               <input type="tel" name="num tele" placeholder="N° de téléphone *"
                    class="text-sm block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40">
            </div>
        ...
        <p class="mt-8 text-xs font-light text-center text-gray-400"> Déjà inscrit ?<a href="#"
                class="font-medium text-gray-700 dark:text-gray-200 hover:underline"> Connectez-vous</a></p>
</div>
</div>
